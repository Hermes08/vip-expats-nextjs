        ...
        <div className="pt-24 min-h-screen bg-white text-brand-950 font-sans selection:bg-brand-GOLD selection:text-brand-950">
            ...
            <section className="py-32 max-w-7xl mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-24 items-center mb-32">
                    <div>
                        <h2 className="text-4xl md:text-7xl font-heading font-black mb-10 uppercase tracking-tighter italic leading-none">The 2026 <br /><span className="text-brand-GOLD underline">Legal Reality</span></h2>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={idx} className="p-8 bg-neutral-50 rounded-[3rem] border border-neutral-100">
                ...
                <div className="text-center mb-20 px-4">
                    <h2 className="text-4xl md:text-7xl font-heading font-black mb-6 uppercase tracking-tighter italic text-center underline italic">The Big <span className="text-brand-GOLD">Three</span></h2>
                    <p className="text-neutral-500 text-lg uppercase tracking-widest font-black italic text-center">90% of Successful Expats choose one of these paths.</p>
                </div>

                <div className="grid lg:grid-cols-3 gap-8 mb-32">
                    {visaTypes.map((visa, i) => (
                        <div key={i} className="border border-neutral-200 p-12 rounded-[4rem] flex flex-col hover:shadow-2xl transition-all group relative overflow-hidden">
                ...
                <div className="bg-neutral-950 text-white p-16 rounded-[5rem] mb-32 relative overflow-hidden">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="flex gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400 font-medium leading-relaxed">Using a simple notary when an Apostille is required at the federal level.</p>
                                </div>
                            </div>
                            <div className="flex gap-6">
                                <div className="bg-white/5 p-4 rounded-2xl h-fit">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400 font-medium leading-relaxed">Failing to have documents translated by a Panamanian-certified translator.</p>
                                </div>
                            </div>
                            <div className="flex gap-6">
                                <div className="bg-white/5 p-4 rounded-2xl h-fit">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400 font-medium leading-relaxed">Gathering papers too early and having them expire before the filing appointment.</p>
                                </div>
                            </div>
                            <div className="flex gap-6">
                                <div className="bg-white/5 p-4 rounded-2xl h-fit">
                ...
                {/* The Comparison Hub */}
                <div className="text-center mb-20 px-4">
                    <h2 className="text-4xl md:text-7xl font-heading font-black mb-6 uppercase tracking-tighter italic text-center italic leading-none">Match Your <span className="text-brand-GOLD underline italic">Lifestyle</span></h2>
                    <p className="text-neutral-500 text-lg uppercase tracking-widest font-black italic text-center">Which visa fits your current reality?</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8 mb-32">
                    <div className="p-12 bg-neutral-50 rounded-[4rem] border border-neutral-100 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-neutral-600 font-medium text-sm leading-relaxed mb-8">
                    ...
                    <div className="p-12 bg-neutral-900 text-white rounded-[4rem] flex flex-col justify-between">
                        <div>
            ...
            {/* Quick Summary Table */}
            <section className="py-32 bg-brand-950 text-white rounded-[5rem] mx-4 mb-20 overflow-hidden relative">
