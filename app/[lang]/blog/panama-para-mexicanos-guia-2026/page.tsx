...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const slug = 'panama-para-mexicanos-guia-2026';
  ...
  alternates: {
    ...
    languages: {
      ...
      'x-default': 'https://panamarealestatesale.com/es/blog/panama-para-mexicanos-guia-2026',
    },
  },
  openGraph: {
    title: 'Guía Panamá para Mexicanos 2026: Visa, Costos, Residencia',
...
const mexicoChartData = [
  { label: 'Ciudad de México', value: 1400, color: '#6b7280' },
  { label: 'Guadalajara', value: 1100, color: '#9ca3af' },
      ...
      <article className="max-w-4xl mx-auto px-6 md:px-8 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <div className="my-8 rounded-lg overflow-hidden border border-brand-100 bg-brand-50 h-[450px]">
            <CostBarChart data={mexicoChartData} title="Monthly Cost Comparison (USD)" />
          </div>
