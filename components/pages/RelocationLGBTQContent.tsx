        ...
        <div className="bg-white text-brand-950 min-h-screen font-sans">
            ...
            <section className="py-32">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        <div>
                            <h2 className="text-4xl md:text-7xl font-heading font-black mb-10 uppercase tracking-tighter italic leading-none text-brand-950">Transparency <br /><span className="text-brand-GOLD underline italic">First.</span></h2>
                                ...
                                <div className="grid grid-cols-2 gap-8 pt-8 border-t border-neutral-100">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-neutral-500">Casco Viejo & El Cangrejo</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-neutral-500">Individual 'Friendly Nations' focus</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="relative aspect-[4/5] rounded-[5rem] overflow-hidden shadow-2xl">
                            <Image
            ...
            <section className="py-32 bg-neutral-900 text-white rounded-[5rem] mx-4 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-8 relative z-10">
                    <div className="text-center mb-20 px-4">
                        <h2 className="text-4xl md:text-8xl font-heading font-black mb-6 uppercase tracking-tighter italic leading-none text-center">The <span className="text-brand-GOLD italic">Proud</span> Perspective</h2>
                        <p className="text-gray-400 font-black uppercase tracking-widest text-[10px] mx-auto text-center italic">Why the community is choosing Panama in 2026.</p>
                    </div>
            ...
            <section className="py-32">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-24">
                        <h2 className="text-4xl md:text-7xl font-heading font-black mb-6 uppercase tracking-tighter italic">City <span className="text-brand-GOLD underline italic">Soul.</span></h2>
                        <p className="text-neutral-500 font-medium italic">The neighborhoods that welcome everyone.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        {[
                            ...
                            <div key={idx} className="group relative overflow-hidden rounded-[4rem]">
            ...
            <section className="py-32 bg-neutral-50 border-t border-neutral-100">
                <div className="max-w-3xl mx-auto px-4">
                    <h2 className="text-3xl md:text-6xl font-heading font-black mb-20 text-center uppercase tracking-tighter italic">The <span className="text-brand-GOLD italic">Real</span> Talk</h2>
