...
import { Coffee, Mountain, Thermometer, ArrowRight, ShieldCheck, TrendingUp } from 'lucide-react';
...
interface BoquetePageContentProps {
  lang: string;
}

const BoquetePageContent = ({ lang }: BoquetePageContentProps) => {
  const isEn = lang === 'en';
  ...
  const boqueteProjects = PROJECTS.filter(p => p.location?.en?.toLowerCase().includes('boquete') || p.location?.es?.toLowerCase().includes('boquete')).slice(0, 3);
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            ...
            <div className="reveal-on-scroll stagger-2">
              ...
              <h2 className="text-5xl md:text-8xl font-heading font-black text-brand-950 mb-10 tracking-tighter uppercase italic leading-[0.8]">
                {isEn ? "The Eternal Spring Advantage" : "La Ventaja de la Eterna Primavera"}
              </h2>
        ...
        <section className="py-48 bg-brand-50 relative rounded-[6rem] border border-brand-100 px-10">
          <div className="text-center mb-32 reveal-on-scroll">
            ...
            <h2 className="text-5xl md:text-8xl font-heading font-black text-brand-950 mb-12 tracking-tighter uppercase italic leading-[0.8]">
              {isEn ? "Featured Boquete Units" : "Unidades Destacadas en Boquete"}
            </h2>
          </div>
...
export default BoquetePageContent;
