      ...
      <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 w-full pt-20 perspective-1000">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-2 glass-card rounded-full mb-8" style={{ transform: 'translateZ(40px)' }}>
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed max-w-2xl mx-auto font-medium" style={{ transform: 'translateZ(30px)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center" style={{ transform: 'translateZ(50px)' }}>
