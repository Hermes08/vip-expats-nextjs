...
const PanamaCityCondosForSaleContent = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <section className="py-24 bg-brand-GOLD text-brand-950 rounded-[6rem] text-center px-10">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <Magnetic strength={0.4}>
              <Link href={`/${lang}/guides/buying-property-panama-us-citizens`} className="btn-3d btn-3d-gold px-16 py-8 rounded-full font-black uppercase tracking-[0.3em] text-xs">
...
export default PanamaCityCondosForSaleContent;
