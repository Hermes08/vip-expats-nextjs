...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const descriptions = {
    ...
    de: "Vollständiger Leitfaden für Panama-Immobilien. Finden Sie Strandwohnungen, Luxushäuser, Anlageobjekte und Grundstücke in Panama. Expertenberatung für Expats und Investoren."
  };
