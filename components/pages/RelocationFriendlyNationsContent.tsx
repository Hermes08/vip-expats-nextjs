...
const RelocationFriendlyNationsContent: React.FC = () => {
    ...
    return (
        <div className="pt-24 min-h-screen bg-white text-brand-950 font-sans selection:bg-brand-GOLD selection:text-brand-950">
            ...
            {/* Header / Hero */}
            <section className="relative min-h-screen flex items-center overflow-hidden border-b border-brand-100 bg-white">
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-10 uppercase tracking-tighter italic leading-none">The <span className="text-brand-GOLD">Panama Real Estate Sale</span> Choice</h2>
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="text-center mb-24">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-6 uppercase tracking-tighter italic leading-none">Choose Your <span className="text-brand-GOLD">Trajectory</span></h2>
                    <p className="text-slate-500 font-black uppercase tracking-widest text-xs">There are only two ways in. Let's find yours.</p>
                </div>

                <div className="grid lg:grid-cols-2 gap-12">
                    {/* Professional Path */}
                    <div className="p-16 card-light rounded-2xl group hover:border-brand-GOLD/50 transition-all border-brand-100">
                        ...
                        <p className="text-lg text-slate-500 font-medium leading-relaxed mb-10 opacity-80">
                        ...
                        <ul className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div className="text-xs font-black uppercase tracking-widest text-slate-500">Local Job Offer Verified</div>
                            </li>
                            <li className="flex gap-4">
                                <div className="w-8 h-8 rounded-full bg-brand-GOLD/10 flex items-center justify-center shrink-0 shadow-[0_0_10px_theme(colors.brand.GOLD)]/10">
                                    <Check size={14} className="text-brand-GOLD" />
                                </div>
                                <div className="text-xs font-black uppercase tracking-widest text-slate-500">Social Security Compliance</div>
                            </li>
                        </ul>
                    </div>

                    {/* Investment Path */}
                    <div className="p-16 bg-brand-50 text-brand-950 rounded-2xl relative overflow-hidden group border border-brand-100">
            ...
            <section className="py-14 bg-brand-GOLD text-brand-950 rounded-3xl mx-4 overflow-hidden relative">
                <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="bg-white/90 p-6 rounded-2xl text-sm font-medium leading-[1.8] border border-brand-950/10 shadow-2xl">
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-20 items-center">
                    <div className="lg:w-1/2">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-10 uppercase tracking-tighter italic leading-none text-brand-950">Why Apps <br /> Get <span className="text-red-500">Rejected</span></h2>
                    ...
                    <div className="lg:w-1/2 p-6 bg-white rounded-2xl text-brand-950 border border-brand-100">
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="text-center mb-24">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-6 uppercase tracking-tighter italic">The 2026 <br /><span className="text-brand-GOLD">Labor Market</span></h2>
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">Where the Panama Real Estate Sale Friendly Nations are finding success.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8 text-lg text-slate-500 font-medium leading-[1.8]">
                        ...
                        <ul className="grid grid-cols-2 gap-4">
                            <li className="p-6 bg-white rounded-2xl border border-brand-100 font-black uppercase tracking-tighter text-xs">FinTech & Crypto</li>
                            <li className="p-6 bg-white rounded-2xl border border-brand-100 font-black uppercase tracking-tighter text-xs">Cybersecurity</li>
                            <li className="p-6 bg-white rounded-2xl border border-brand-100 font-black uppercase tracking-tighter text-xs">Supply Chain Tech</li>
                            <li className="p-6 bg-white rounded-2xl border border-brand-100 font-black uppercase tracking-tighter text-xs">Renewable Energy</li>
                        </ul>
                        <p>
                    ...
                    <div className="bg-brand-GOLD p-8 rounded-2xl text-brand-950 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-20">
                        <div className="space-y-10">
                            <div className="p-10 bg-white rounded-2xl border border-brand-100">
                                ...
                                <p className="mt-8 text-xs text-slate-500 font-medium">Best for: Those seeking a 'home base' or a tangible asset that offsets local living costs.</p>
                            </div>
                        </div>
                        <div className="space-y-10">
                            <div className="p-10 bg-brand-50 text-brand-950 rounded-2xl">
                                ...
                                <div className="space-y-4 text-sm font-bold">
                                    <div className="flex justify-between border-b border-brand-100 pb-2"><span>Estimated Yield</span><span className="text-brand-GOLD">4.5% - 5.5%</span></div>
                                    <div className="flex justify-between border-b border-brand-100 pb-2"><span>Risk Rating</span><span className="text-brand-GOLD">Low (Investment Grade)</span></div>
            ...
            <section className="py-14 bg-white relative">
                <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row-reverse gap-20 items-center">
                    <div className="lg:w-1/2">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-10 uppercase tracking-tighter italic leading-none">The <span className="text-brand-GOLD">E-Cedula</span> <br /> Advantage</h2>
                        <div className="space-y-8 text-lg text-slate-500 font-medium leading-[1.8]">
                            <p>
                    ...
                    <div className="lg:w-1/2 aspect-video bg-white/5 rounded-2xl flex items-center justify-center p-20 border border-brand-100">
                        <div className="w-full aspect-[1.6/1] bg-brand-50 rounded-3xl p-6 border-t-4 border-brand-GOLD shadow-2xl">
            ...
            <section className="py-14 max-w-5xl mx-auto px-4">
                <div className="text-center mb-24">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-6 uppercase tracking-tighter italic leading-none">Questions <br /> <span className="text-brand-GOLD">Exposed</span></h2>
                    <p className="text-slate-500 font-black uppercase tracking-widest text-xs">No Fluff. Just Facts.</p>
                </div>
            ...
            {/* Final CTA */}
            <section className="py-14 text-center border-t border-brand-100">
                <div className="max-w-4xl mx-auto">
                    <ShieldCheck className="text-brand-GOLD mx-auto mb-10" size={80} />
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black mb-12 uppercase tracking-tighter italic leading-none">Your Panama Real Estate Sale <br /> Future Awaits</h2>
