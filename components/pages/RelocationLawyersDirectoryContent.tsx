...
const RelocationLawyersDirectoryContent: React.FC = () => {
    ...
    return (
        <div className="pt-24 min-h-screen bg-white text-brand-950 font-sans selection:bg-brand-GOLD selection:text-brand-950">
            ...
            <section className="relative min-h-[85vh] flex items-center overflow-hidden border-b border-brand-100 bg-brand-50">
            ...
            <section id="directory" className="py-14 max-w-7xl mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div>
                        ...
                        <p className="text-slate-500 font-black uppercase tracking-widest text-xs mt-4">Top 1% vetted for 2026 relocation.</p>
                    </div>
                    <div className="flex gap-4">
                        <div className="relative">
                            <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-500" size={18} />
                            <input type="text" placeholder="Search by name..." className="pl-14 pr-10 py-5 bg-white border border-brand-100 rounded-2xl text-xs font-bold w-64 focus:border-brand-GOLD outline-none transition-all" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {lawyers.map((lawyer, i) => (
                        <motion.div
                            ...
                            className="group card-light rounded-2xl border-brand-100/10 p-6 hover:border-brand-GOLD transition-all shadow-xl bg-white/5 backdrop-blur-xl"
                        >
                            ...
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <h3 className="text-2xl font-black uppercase tracking-tighter italic text-brand-950 mb-2 group-hover:text-brand-GOLD transition-colors">{lawyer.name}</h3>
                            ...
                            <div className="space-y-4 mb-10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-black uppercase tracking-widest text-slate-500">{lawyer.specialty}</span>
                                </div>
                                <p className="text-sm text-slate-500 font-medium leading-relaxed italic border-l-2 border-brand-GOLD/30 pl-4 opacity-80 font-serif-luxury tracking-normal">
                                    "{lawyer.description}"
                                </p>
                            </div>
                        ...
                        <div className="space-y-8 text-lg text-slate-500 font-medium leading-[1.8]">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="p-8 bg-white rounded-3xl shadow-sm border border-brand-100">
                                    ...
                                    <p className="text-[10px] text-slate-500 leading-relaxed font-bold">We manually verify every client review to ensure authenticity.</p>
                                </div>
                                <div className="p-8 bg-white rounded-3xl shadow-sm border border-brand-100">
                                    ...
                                    <p className="text-[10px] text-slate-500 leading-relaxed font-bold">Search of Bar Association records for any disciplinary actions.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-14 max-w-5xl mx-auto px-4">
                <div className="text-center mb-24">
                    ...
                    <p className="text-slate-500 font-black uppercase tracking-widest text-xs mt-8">Navigating the Panama Legal System 2026.</p>
                </div>
