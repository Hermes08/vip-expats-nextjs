...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full shadow-lg hover:scale-105 transition-transform duration-200
    ...
    >
      ...
      {/* "Chat" label — desktop only */}
      <span className="hidden md:inline text-white font-black text-sm uppercase tracking-wider">
        Chat
      </span>
    </a>
  );
