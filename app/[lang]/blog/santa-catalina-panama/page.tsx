...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const slug = 'santa-catalina-panama';
  ...
  return {
    ...
    alternates: {
        ...
        languages: {
            ...
            'x-default': 'https://panamarealestatesale.com/en/blog/santa-catalina-panama',
        },
    },
    openGraph: {
        title: 'Santa Catalina Panama 2026: Surf Beach, Real Estate, Lifestyle',
...
export default async function SantaCatalinaPanama({ params }: { params: Promise<{ lang: string }> }) {
    const { lang } = await params;
  return (
