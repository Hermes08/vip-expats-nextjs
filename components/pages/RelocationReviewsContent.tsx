    ...
    return (
        <div className="pt-24 min-h-screen bg-white text-brand-950 font-sans">
            ...
            <section className="py-14 text-center px-4">
                ...
                <Link href={`/${lang}/relocation/tours`} className="px-8 py-4 bg-brand-GOLD text-brand-950 font-black uppercase tracking-[0.3em] text-xs rounded-full hover:bg-white transition-all shadow-2xl">
                    Explore Our Tours
                </Link>
            </section>
        </div>
