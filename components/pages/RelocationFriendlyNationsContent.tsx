        ...
        <div className="pt-24 min-h-screen bg-white text-brand-950 font-sans selection:bg-brand-GOLD selection:text-brand-950">
            ...
            <section className="py-14 bg-brand-950 rounded-3xl mx-4">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="text-center mb-24">
                        ...
                        <p className="text-slate-400 font-black uppercase tracking-widest text-xs">The Official 50+ Country List for 2026.</p>
                    </div>
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="text-center mb-24">
                    ...
                    <p className="text-slate-400 font-black uppercase tracking-widest text-xs">There are only two ways in. Let's find yours.</p>
                </div>

                <div className="grid lg:grid-cols-2 gap-12">
                    {/* Professional Path */}
                    <div className="p-16 glass-card rounded-2xl group hover:border-brand-GOLD/50 transition-all border-white/5">
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-20 items-center">
                    ...
                    <div className="lg:w-1/2 p-6 bg-black rounded-2xl text-white">
            ...
            <section className="py-14 max-w-7xl mx-auto px-4">
                <div className="text-center mb-24">
                    ...
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Where the Panama Real Estate Sale Friendly Nations are finding success.</p>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20">
                        <div className="space-y-10">
                            <div className="p-10 bg-brand-950 rounded-2xl border border-brand-100">
                                ...
                                <p className="mt-8 text-xs text-slate-400 font-medium">Best for: Those seeking a 'home base' or a tangible asset that offsets local living costs.</p>
                            </div>
                        </div>
                        <div className="space-y-10">
            ...
            <section className="py-14 bg-white/5 rounded-3xl mx-4 overflow-hidden relative">
                <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="bg-brand-950 p-8 rounded-2xl text-white shadow-2xl skew-x-1">
                        <h4 className="text-3xl font-black uppercase tracking-tighter mb-8 italic text-brand-GOLD">The 0% Reality</h4>
                        <p className="font-medium text-slate-400 leading-relaxed mb-8">
            ...
            <section className="py-14 max-w-5xl mx-auto px-4">
                <div className="text-center mb-24">
                    ...
                    <p className="text-slate-400 font-black uppercase tracking-widest text-xs">No Fluff. Just Facts.</p>
                </div>
            ...
            {/* Final CTA */}
            <section className="py-14 text-center border-t border-white/10">
