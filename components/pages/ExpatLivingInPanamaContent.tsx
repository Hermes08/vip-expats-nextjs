...
import { Globe, Heart, Shield, DollarSign, Utensils, Hospital, Coffee, Sun, ArrowRight } from 'lucide-react';
import Link from 'next/link';
import { useLanguage } from '@/context/LanguageContext';
import Magnetic from '@/components/ui/Magnetic';
import HeroTilt from '@/components/ui/HeroTilt';

const ExpatLivingInPanamaContent = () => {
...
export default ExpatLivingInPanamaContent;
